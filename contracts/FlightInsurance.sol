...
contract FlightInsurance is usingOraclize {
    ...
    mapping(string => bool) supportedFlight;
    ...
    function isSupported(string memory flightNo) public view returns(bool) {
         return supportedFlight[flightNo];
    }
    ...
    function insure(string memory flightNo,uint expDate) public payable {
         ...
         require(DateTime.comparingToTimeStamp(now + 86400,expectedDate) < 0,"Please insure 48 hours ahead of departure");
    ...
    function claimCompensation(bytes32 order_id) public returns(bool) {
        ...
        (,,,uint delaySeconds) = getFlightStatus(order.flightNo,order.expectedDepatureDate);
        ...
        emit LogUint("delaySeconds",delaySeconds);
    ...
    function __callback(bytes32 myid, string memory result) public {
           ...
           if(callback.oState == OraclizeState.CheckValid) {
               ...
               supportedFlight[callback.flightNo] = true;
