...
const OrderInformation = AsyncLoader(()=>import(/* webpackChunkName: "OrderInformation" */'./app/pages/OrderInformation').then((cmp)=>cmp["OrderInformation"]))
const AccountInformation = AsyncLoader(()=>import(/* webpackChunkName: "AccountInformation" */ './app/pages/AccountInformation').then((cmp)=>cmp["AccountInformation"]))
const Donate = AsyncLoader(()=>import(/* webpackChunkName: "Donate" */"./app/pages/Donate").then((cmp)=>cmp["Donate"]))
const Insure = AsyncLoader(()=>import(/* webpackChunkName: "Insure" */"./app/pages/Insure").then((cmp)=>cmp["Insure"]))
